...
| 7 | **Proof — live on Monad mainnet, 331 tests** | 10 s | "Live on Monad mainnet, all Monadscan-verified. Three hundred thirty-one tests across Python and Foundry. The post-quantum signature is verified on-chain by a zero-knowledge proof. Reproducible from a cold clone." *(20 words, ~7 s)* — leave 3 s of silence for the numbers to land |
