...
| 7 | **Proof — live on Monad mainnet, 370 tests** | 10 s | "Live on Monad mainnet, all Monadscan-verified. Three hundred seventy tests across Python and Foundry. The post-quantum signature is verified on-chain by a zero-knowledge proof. Reproducible from a cold clone." *(20 words, ~7 s)* — leave 3 s of silence for the numbers to land |
