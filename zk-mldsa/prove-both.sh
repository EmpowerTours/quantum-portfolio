...
echo
echo "The vkey above must equal what MLDSAAttestationV2 pins:"
echo "  cast call 0xFeEf24A5dBF43E9dE8AC0d0EaB0f0141E980A52c \\"
echo "    'mldsaProgramVKey()(bytes32)' --rpc-url https://rpc.monad.xyz"
